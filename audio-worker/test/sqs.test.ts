...
describe('SQS Operations', () => {
  ...
  describe('receiveMessage', () => {
    it('should receive message from queue', async () => {
      ...
      const result = await receiveMessage(mockSqsClient as any, 'https://queue-url');
  ...
  describe('parseMessage', () => {
    it('should parse message body with text and hash', () => {
      ...
      const result = parseMessage(message as any);
  ...
  describe('deleteMessage', () => {
    it('should delete message from queue', async () => {
      ...
      await deleteMessage(mockSqsClient as any, 'https://queue-url', 'receipt-123');
