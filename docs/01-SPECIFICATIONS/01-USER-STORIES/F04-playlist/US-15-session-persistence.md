...
- [x] **AC-5:** Cached audio URLs are preserved for replay without re-synthesis
...
- Sanitizes transient state before saving
...
- [US-035-session-persistence.feature](../../../../packages/specifications/playlist/US-035-session-persistence.feature)
