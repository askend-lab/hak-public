...
- [ ] **AC-1:** "Logi sisse" button is visible in header when not authenticated
- [ ] **AC-2:** Clicking opens the Login modal
- [ ] **AC-3:** Modal offers three authentication methods: Smart-ID, Mobiil-ID, ID-kaart
- [ ] **AC-4:** Isikukood (personal ID code) input field is available
- [ ] **AC-5:** Input validates isikukood format
- [ ] **AC-6:** Invalid format shows error message
- [ ] **AC-7:** Valid credentials authenticate user
- [ ] **AC-8:** Session persists in localStorage
- [ ] **AC-9:** User profile appears in header after login
- [ ] **AC-10:** Login modal closes after successful authentication
...
- Smart-ID/Mobiil-ID/ID-kaart tabs are visual only (same flow)
