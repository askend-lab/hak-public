...
- [ ] **AC-1:** "Logi välja" option is available in profile dropdown
- [ ] **AC-2:** Clicking logs out the user immediately
- [ ] **AC-3:** Session is cleared from localStorage
- [ ] **AC-4:** AuthContext is cleared
- [ ] **AC-5:** User is redirected to Synthesis view if on Tasks view
- [ ] **AC-6:** "Logi sisse" button reappears in header
- [ ] **AC-7:** No confirmation dialog required
...
- Task data remains in localStorage (accessible after re-login)
