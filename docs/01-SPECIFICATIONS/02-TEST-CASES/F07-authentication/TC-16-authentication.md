...
| 4 | Verify error | "Vale isikukoodi formaat" or similar | ☐ |
...
| 4 | Check localStorage | User data present | ☐ |
...
| 4 | Check localStorage | User data removed | ☐ |
...
- All three auth tabs (Smart-ID/Mobiil-ID/ID-kaart) use same flow
