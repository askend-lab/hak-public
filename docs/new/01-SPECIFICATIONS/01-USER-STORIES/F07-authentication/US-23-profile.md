...
- [x] **AC-1:** User name is visible in header when authenticated
- [x] **AC-2:** Profile area shows user's name with dropdown indicator
- [x] **AC-3:** Profile dropdown/menu is accessible by clicking
- [x] **AC-4:** Logout option is available in dropdown
- [x] **AC-5:** Profile replaces "Logi sisse" button
