...
| 2 | Verify header | Task name visible (description if exists), menu button | ☐ |
| 3 | Verify entries | All entries displayed as sentence rows | ☐ |
| 4 | Click play on entry | Audio synthesizes and plays | ☐ |
| 5 | Click "Ülesanded" in header | Returns to task list | ☐ |

### Entry Row Menu

| # | Action | Expected Result | Pass |
|---|--------|-----------------|------|
| 1 | Click ⋯ menu on entry row | Menu opens | ☐ |
| 2 | Verify menu options | "Uuri häälduskuju", "Kopeeri tekst", "Kustuta" | ☐ |
| 3 | Select "Kopeeri tekst" | Text copied to clipboard | ☐ |
| 4 | Verify notification | "Tekst kopeeritud!" shown | ☐ |
...
| 4 | Change name | Name updated in input | ☐ |
...
| 3 | Verify CTA button | "Loo esimene ülesanne" button present | ☐ |
