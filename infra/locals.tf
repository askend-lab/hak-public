...
locals {
  ...
  # API Gateway domains (no public DNS — extracted from CloudFormation ApiEndpoint output)
  # Format: https://{api-id}.execute-api.{region}.amazonaws.com (hostname only, no stage path)
