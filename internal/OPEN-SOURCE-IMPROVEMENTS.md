...
- [x] **1.1. Убрать docs/internal/ из public repo**
...
- [x] **1.2. Добавить CODE_OF_CONDUCT.md**
...
- [x] **1.3. Отключить force push на main**
...
- [x] **1.4. Добавить required status checks**
...
- [x] **1.5. Проверить E2E workflow на совместимость с fork PRs**
...
- [x] **2.3. Добавить .github/dependabot.yml**
...
- [x] **2.4. Добавить CI status badge в README**
...
- [x] **2.6. Добавить скриншоты/демо в README** — SKIP по решению Alex
...
- [x] **3.1. Добавить .github/ISSUE_TEMPLATE/config.yml**
...
- [x] **3.3. Добавить FUNDING.yml** — отложено, не актуально
...
- [x] **3.5. Дополнить SPDX headers в 8 файлах**
