...
|---|--------|-----------------|------|
| 1 | Navigate to task list | Tasks visible | ☐ |
| 2 | Click ⋯ menu on task | Menu opens | ☐ |
| 3 | Select "Jaga" | Share modal opens | ☐ |
| 4 | Verify modal content | Task name and share URL displayed | ☐ |
| 5 | Verify URL format | Contains share token | ☐ |
| 6 | Click "Kopeeri" button | URL copied to clipboard | ☐ |
| 7 | Verify notification | "Link kopeeritud!" shown | ☐ |
...
| 4 | Verify entries | All entries visible as tags | ☐ |
| 5 | Click play on entry | Audio synthesizes and plays | ☐ |
| 6 | Click "Mängi kõik" | All entries play sequentially | ☐ |
...
| 2 | Look for entry menu | Limited options (no edit/delete) | ☐ |
| 3 | Try to modify entries | Not possible | ☐ |
...
| 2 | Click "Kopeeri" button in info banner | Action triggered | ☐ |
| 3 | Observe navigation | Redirects to synthesis view | ☐ |
| 4 | Verify sentences | All entries appear as editable sentences | ☐ |
