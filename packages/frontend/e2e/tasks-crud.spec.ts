...
test.describe("Tasks CRUD Operations", () => {
  ...
  test("Create - should create a new task", async ({ page }) => {
    ...
    // Fill in task name
    await page
      .locator('[data-testid="create-task-name-input"]')
      .fill(testTaskName);
    ...
    await expect(
      page.locator('[data-testid="task-list"]').getByText(testTaskName),
    ).toBeVisible();
  });
  ...
  test("Update - should edit a task", async ({ page }) => {
    ...
    // Wait for modal to close
    await expect(
      page.locator('[data-testid="edit-task-modal"]'),
    ).not.toBeVisible();
  ...
  test("Delete - should delete a task", async ({ page }) => {
    ...
    await expect(
      page.locator('[data-testid="delete-confirm-modal"]'),
    ).toBeVisible();
