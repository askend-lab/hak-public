...
describe('BuildInfo runtime fetch', () => {
  it('shows buildId from build-info.json', async () => {
    vi.stubGlobal('fetch', vi.fn().mockResolvedValueOnce({
      ok: true, json: () => Promise.resolve({ buildId: 'BUILD-123', commitHash: 'abc', branch: 'main', deployedAt: '2026-01-13T12:00:00Z' }),
    } as Response));
    Object.defineProperty(window, 'location', { value: { hostname: 'hak-dev.askend-lab.com' }, writable: true });
    render(<BuildInfo />);
