  ...
  <div className="footer-section">
    ...
    <div className="footer-feedback-content">
      <p className="footer-description">
        Iga arvamus loeb ja aitab Hääldusabilist paremaks teha! Saada meile oma mõtted ja ettepanekud.
      </p>
      <a href="mailto:kristjan.suluste@eki.ee" className="footer-feedback-link">
        <svg className="footer-feedback-icon" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const FooterSponsors = () => (
  <div className="footer-sponsors">
    <div className="footer-sponsors__content">
      <img src="/icons/kaasrahastamine_logo.jpeg" alt="Kaasrahastanud Euroopa Liit" className="footer-sponsors__logo" />
      <img src="/icons/ks_logo.png" alt="Eesti tuleviku heaks" className="footer-sponsors__logo" />
      <img src="/icons/hjtm_logo.png" alt="Haridus- ja Teadusministeerium" className="footer-sponsors__logo" />
    </div>
  </div>
);
...
export default function Footer() {
  return (
    <>
      <div className="page-footer__content"><FooterLogo /><FooterLinks /><SocialLinks /><FeedbackSection /><div className="footer-build-info"><BuildInfo /></div></div>
      <FooterSponsors />
    </>
  );
}
