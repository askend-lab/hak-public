...
const markers = [
  ...
  { symbol: "'", name: 'palatalisatsioon', rule: 'Võib paikneda konsonantide d, l, n, s ja t järel. Kahetähelise pika hääliku puhul on see märk vaid esimese tähe järel.', examples: ["pad'ja", "p`an't", "k`as't", "s`al'l"] },
  ...
  return (
    <div className="pronunciation-variants__guide-view">
      ...
      <div className="pronunciation-variants__guide-view-content">
        <p className="pronunciation-variants__guide-intro">Foneetilised märgid aitavad täpsustada sõna hääldust. Klõpsa märgil, et lisada see kursori asukohta.</p>
