...
export const SpeedIcon = ({ size = 16, className }: IconProps) => (
...
export const DocumentPlusIcon = ({ size = 16, className }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
...
export const HelpIcon = ({ size = 24, className }: IconProps) => (
