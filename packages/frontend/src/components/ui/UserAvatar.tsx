...
interface UserAvatarProps {
  ...
  onReset?: () => void
  onLogout?: () => void
  onRefreshToken?: (() => Promise<void>) | undefined  // Temporary: for testing token refresh
}

export function UserAvatar({ initials, name, email, idCode, onReset, onLogout, onRefreshToken }: UserAvatarProps) {
        ...
        <div className="user-avatar__dropdown">
          ...
          {onRefreshToken && (
            <button 
              ...
              onClick={() => { void onRefreshToken(); setIsOpen(false); }}
              type="button"
              style={{ color: '#0066cc' }}
            >
              <RefreshIcon />
