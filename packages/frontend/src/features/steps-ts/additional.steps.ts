...
Given('I am viewing a baseline task', function () {
  ...
  this.currentTask = { id: 'baseline-1', name: 'Baseline Task', isBaseline: true };
});
...
Given('I have entered {string} in the message field', function (_message: string) {
...
Given('I have a task with {int} entries', function (count: number) {
  this.currentTask = {
    id: 'task-1',
    name: 'Test Task',
    entries: Array.from({ length: count }, (_, i) => ({ id: `e${i + 1}`, text: `Entry ${i + 1}` })),
  };
});

Given('I have tasks named {string} and {string}', function (t1: string, t2: string) {
  this.tasks = [
    { id: 'task-1', name: t1 },
    { id: 'task-2', name: t2 },
  ];
...
When('I drag sentence {string} to position after {string}', function (_from: string, _to: string) {
...
When('I click the {string} button for custom variant', function (_button: string) {
...
Then('the {string} button shows login required', function (_buttonName: string) {
...
Then('the order becomes {string}, {string}, {string}', function (_s1: string, _s2: string, _s3: string) {
...
Then('the search input has placeholder {string}', function (_placeholder: string) {
...
Then('I see a {string} button showing count {string}', function (_button: string, _count: string) {
...
Then('I see the entry count {string} next to the task', function (_count: string) {
