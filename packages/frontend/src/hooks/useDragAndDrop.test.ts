...
describe('useDragAndDrop', () => {
  const createMockSentences = (): SentenceState[] => [
    { id: '1', text: 'Hello', tags: ['Hello'], stressedTags: ['Hello'], currentInput: '', isPlaying: false, isLoading: false },
    { id: '2', text: 'World', tags: ['World'], stressedTags: ['World'], currentInput: '', isPlaying: false, isLoading: false },
  ...
  describe('handleDrop', () => {
    it('calls setSentences with reordered array', () => {
      ...
      mockSetSentences.mockImplementation((updater: (prev: SentenceState[]) => SentenceState[]) => {
    ...
    it('resets state after drop', () => {
      const sentences = createMockSentences();
      mockSetSentences.mockImplementation((updater: (prev: SentenceState[]) => SentenceState[]) => updater(sentences));
