...
describe('AuthStorage', () => {
  ...
  describe('clear', () => {
    ...
    it('should clear Cognito-related localStorage keys', () => {
      ...
      expect(localStorage.getItem('CognitoIdentityServiceProvider.abc.user')).toBeNull();
      expect(localStorage.getItem('CognitoIdentityServiceProvider.abc.token')).toBeNull();
