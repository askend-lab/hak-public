...
`,
  ...
  'US-039-sentence-context-menu 2': `@ready @synthesis @menu @US-039
...
`,
  ...
  'US-047-playback-errors 2': `@ready @synthesis @playback @US-047
...
`,
  ...
  'US-049-text-input-behavior 2': `@ready @synthesis @input @US-049
...
`,
  ...
  'US-052-phonetic-panel 2': `@ready @synthesis @phonetic @US-052
...
`,
  ...
  'US-055-tag-editing 2': `@ready @synthesis @tags @US-055
...
`,
  ...
  'US-056-voice-model-selection 2': `@ready @synthesis @voice @US-056
...
`,
  ...
  'US-060-text-analysis 2': `@ready @synthesis @analysis @US-060
...
`,
  ...
  'US-061-pronunciation-variants-panel 2': `@ready @synthesis @variants @US-061
...
`,
  ...
  'US-062-phonetic-markers 2': `@ready @synthesis @markers @US-062
...
`,
  ...
  'US-064-synthesis-polling 2': `@ready @synthesis @api @US-064
...
`,
  ...
  'US-068-custom-variant-form 2': `@ready @synthesis @custom-variant @US-068
...
`,
  ...
  'US-075-sentence-item-modes 2': `@ready @synthesis @component @US-075
...
`,
  ...
  'US-080-audio-warm-worker 2': `@ready @synthesis @performance @US-080
...
`,
  ...
  'US-081-audio-player-lifecycle 2': `@ready @synthesis @audio @US-081
...
`,
  ...
  'US-085-copy-text-to-clipboard 2': `@ready @synthesis @clipboard @US-085
...
`,
  ...
  'US-086-sentence-download-wav 2': `@ready @synthesis @download @US-086
...
`,
  ...
  'US-089-sentence-menu-auth-guard 2': `@ready @synthesis @auth @US-089
...
`,
  ...
  'US-091-synthesis-view-layout 2': `@ready @synthesis @layout @US-091
...
`,
  ...
  'US-093-demo-sentences 2': `@ready @synthesis @onboarding @US-093
...
`,
  ...
  'US-096-stressed-text-display 2': `@ready @synthesis @display @US-096
...
`,
  ...
  'US-098-variants-api-error 2': `@ready @synthesis @variants @US-098
