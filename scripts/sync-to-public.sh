...
# --- Clean up docs/adr/README.md (remove broken ADR links) ---
echo ">>> Cleaning docs/adr/README.md..."
if [[ -f docs/adr/README.md ]]; then
  sed -i '/002-serverless-aws/d' docs/adr/README.md
  sed -i '/003-tdd-devbox/d' docs/adr/README.md
  echo "  Removed references to excluded ADRs"
fi
...
if [[ -f .gitignore ]]; then
  ...
  sed -i '/packages\/merlin-worker/d' .gitignore
